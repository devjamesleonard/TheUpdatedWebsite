<?php
setcookie('currentpage','Branches.php');
...
<body>
  ...
  <div class="rectangle" id="SideBar">
   ...
   echo'<a href = "profile.php">  <button class="login" type = "button" onclick = "lastpage("Branches.php")"> Profile </button></a>';
   }else{
   echo'<a href = "submissionpage.php">  <button class="login" type = "button" onclick = "lastpage("Branches.php")"> Sign In </button></a>';
   }
   ?>
  </br>
   <div id="LeftSide">
