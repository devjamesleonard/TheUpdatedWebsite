...
<input maxlength=20 id="texta" name = "oldpass" type = "textarea"></input>
<div id = "itemtext">
  New Password:
</div>
<input maxlength=20 id="texta" name = "passn" type ="textarea"></input>
<div id = "itemtext">
  Re-Enter New Password:
</div>
<input maxlength=20 id="texta" name = "passntwo" type ="textarea"></input>
</br>
<input id="sub" type= "submit" value = "Next"name="Next"></input>
<a href = "profile.php"> <button id="sub" type = "button"> Back </button></a>
</br>
<div id="error">
