...
<input maxlength=20 id="texta" name = "usern" type = "textarea"></input>
<div id = "itemtext">
  Password:
</div>
<input maxlength=20 id="texta" name = "passn" type ="textarea"></input>
</br>
<input id="sub" type= "submit" value = "submits"name="submits"></input>
<a href = "registeredpage.php"> <button id="sub" type = "button"> Register </button></a>
